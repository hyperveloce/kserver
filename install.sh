...
apt install x11-xserver-utils unzip wget build-essential git samba smbclient cifs-utils neofetch neovim rsync xserver-xorg xterm docker-compose net-tools borgbackup mkcert -y
